...
/**
 * Servlet implementation class CurrentInfo
 */

public class CurrentInfo extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		DatebaseHandler han=new DatebaseHandler();
		han.connSQL();
		 ResultSet  rst=han.selectSQL("select member_name,member_number from sign where gift_taken=3 and group_id="+user);
