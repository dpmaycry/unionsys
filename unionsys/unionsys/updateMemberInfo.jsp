...
member.setMember_id(Integer.valueOf(request.getParameter("member_id")));
...
if(!request.getParameter("member_number").equals(request.getParameter("member_number_old"))&&l.contains(1)){
%>
<script type="text/javascript" >
alert(" 更新失败： 工号为 " + '<%=request.getParameter("member_number")%>' + " 的记录已存在！");
window.history.go(-1); 
</script>	
<%	
}else{
